...
public class OmniCore extends RobotCore {
    ...
    public OmniCore(HardwareMap Hardwares) {
        super("OmniDriveTest.log",Hardwares);
        ...
        RobotWheel m_LeftTopWheel = new RobotWheel(new RobotPose2D(-WHEEL_POS[0],WHEEL_POS[1],45),WHEEL_RADIUS);
        RobotWheel m_RightTopWheel = new RobotWheel(new RobotPose2D(WHEEL_POS[0],WHEEL_POS[1],-45),WHEEL_RADIUS);
        RobotWheel m_LeftBottomWheel = new RobotWheel(new RobotPose2D(-WHEEL_POS[0],-WHEEL_POS[1],135),WHEEL_RADIUS);
        RobotWheel m_RightBottomWheel = new RobotWheel(new RobotPose2D(WHEEL_POS[0],-WHEEL_POS[1],-135),WHEEL_RADIUS);
