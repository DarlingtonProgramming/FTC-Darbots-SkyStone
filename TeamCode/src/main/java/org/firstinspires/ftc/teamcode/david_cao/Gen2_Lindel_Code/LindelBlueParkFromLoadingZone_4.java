...
@Autonomous(group = "4100", name = "Lindel-Blue-LoadingZone-4")
public class LindelBlueParkFromLoadingZone_4 extends LindelAutoBase {
    public static final ParkPosition PARK_POSITION = ParkPosition.NEXT_TO_WALL;
    ...
    public void __init() {
        ...
        initPose.X += 119.38 + 2 + LindelSettings.PHYSICAL_WIDTH;
