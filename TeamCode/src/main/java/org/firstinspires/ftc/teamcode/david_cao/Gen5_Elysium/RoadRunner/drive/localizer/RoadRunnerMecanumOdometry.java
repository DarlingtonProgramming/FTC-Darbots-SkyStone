...
public class RoadRunnerMecanumOdometry extends OdometryMethod {
    ...
    public RoadRunnerMecanumOdometry(MecanumDrivetrain driveTrain) {
        super();
        this.m_MotionSystem = driveTrain;
    }

    public RoadRunnerMecanumOdometry(RoadRunnerMecanumOdometry oldTracker) {
        super(oldTracker);
