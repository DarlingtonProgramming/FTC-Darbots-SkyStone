...
public class ElysiumSettings {
    ...
    public static RobotPoint2D LOCALIZATION_LEFTDISTSENSOR_POS = new RobotPoint2D(13.0,38.5/2);
    public static RobotPoint2D LOCALIZATION_RIGHTDISTSENSOR_POS = new RobotPoint2D(13.0,-38.5/2);
    ...
    public static RobotPoint2D AUTONOMOUS_CLAW_LEFT_POSITION_WHEN_DOWN = new RobotPoint2D(13.5,24.9);
    ...
    public static RobotPoint2D AUTONOMOUS_CLAW_RIGHT_POSITION_WHEN_DOWN = new RobotPoint2D(13.5,-24.9);
    ...
    public static double AUTONOMOUS_CLAW_WAIT_FOR_CLOSE_SEC = 0.5;
    ...
    public static double STACKER_DOOR_LEFT_CLOSED_POS = 0;
    ...
    public static double CAPSTONE_SERVO_IN_POS = 0.785;
