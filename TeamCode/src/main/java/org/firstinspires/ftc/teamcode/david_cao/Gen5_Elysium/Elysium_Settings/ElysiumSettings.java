...
public class ElysiumSettings {
    ...
    public static final double AUTONOMOUS_CLAW_LEFT_INSIDE_POS = 1.0;
    public static final double AUTONOMOUS_CLAW_LEFT_REST_POS = 0.6;
    public static final double AUTONOMOUS_CLAW_LEFT_OUTSIDE_POS = 0.1;
    public static final double AUTONOMOUS_CLAW_LEFT_WIDE_OPEN_POS = 0.0;
    public static final double AUTONOMOUS_CLAW_LEFT_ALL_CLOSED_POS = 1.0;
    public static final double AUTONOMOUS_CLAW_LEFT_GRAB_STONE_POS = 0.6;

    public static final RobotPoint2D AUTONOMOUS_CLAW_RIGHT_POSITION_WHEN_DOWN = new RobotPoint2D(0,0);
    public static final double AUTONOMOUS_CLAW_RIGHT_INSIDE_POS = 0.0;
    public static final double AUTONOMOUS_CLAW_RIGHT_REST_POS = 0.4;
    public static final double AUTONOMOUS_CLAW_RIGHT_OUTSIDE_POS = 0.9;
    public static final double AUTONOMOUS_CLAW_RIGHT_WIDE_OPEN_POS = 1.0;
    public static final double AUTONOMOUS_CLAW_RIGHT_ALL_CLOSED_POS = 0.0;
    public static final double AUTONOMOUS_CLAW_RIGHT_GRAB_STONE_POS = 0.4;
