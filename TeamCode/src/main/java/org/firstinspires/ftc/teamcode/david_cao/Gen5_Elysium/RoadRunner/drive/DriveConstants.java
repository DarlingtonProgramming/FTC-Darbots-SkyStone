package org.firstinspires.ftc.teamcode.david_cao.Gen5_Elysium.RoadRunner.drive;
...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG =
            MotorConfigurationType.getMotorType(GoBilda5202Series1150RPMMotor.class);
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(20,10,0);
     ...
     */
    public static double WHEEL_RADIUS = 5.08;
    public static double GEAR_RATIO = 0.5; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.46 / XYPlaneCalculations.INCH_PER_CM;
