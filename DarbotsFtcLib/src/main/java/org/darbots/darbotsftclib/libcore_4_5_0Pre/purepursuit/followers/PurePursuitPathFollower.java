package org.darbots.darbotsftclib.libcore_4_5_0Pre.purepursuit.followers;
...
import org.darbots.darbotsftclib.libcore_4_5_0Pre.motion_planning.profiles.MotionProfile;
import org.darbots.darbotsftclib.libcore_4_5_0Pre.motion_planning.profiles.MotionProfileGenerator;
import org.darbots.darbotsftclib.libcore_4_5_0Pre.motion_planning.profiles.MotionState;
...
public class PurePursuitPathFollower extends RobotMotionSystemTask {
    ...
    protected void __updateStatus() {
        ...
        if(this.m_EndingStarted){
            ...
            RobotPoint2D error = XYPlaneCalculations.getRelativePosition(currentOffset,endPoint);
        ...
        if(this.m_EndingStarted && distanceToEndPoint <= this.m_ProfileToReachEndSpeedTotalDistance){
            ...
            MotionState currentMotionState = this.m_ProfileToReachEndSpeed.getMotionStateAt(Range.clip(timeForEnding,0,timeToEnd));
